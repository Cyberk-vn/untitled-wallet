export class ChainIdHelper {
  ...
  static parse(chainId: string): {
    ...
    // In the case of injective dev/testnet, there is a difficult problem to deal with titan's chain identifier system...
    // Fundamentally, titan's chain identifier system started when the app was created, so too mnay logic depends on chain identifier.
