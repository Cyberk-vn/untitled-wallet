...
export type TitanMode = "core" | "extension" | "mobile-web" | "walletconnect";

export interface TitanIntereactionOptions {
  readonly sign?: TitanSignOptions;
}

export interface TitanSignOptions {
...
export interface Titan {
  ...
  /**
   * mode means that how Titan is connected.
   * If the connected Titan is browser's extension, the mode should be "extension".
   * If the connected Titan is on the mobile app with the embeded web browser, the mode should be "mobile-web".
   */
  readonly mode: TitanMode;
