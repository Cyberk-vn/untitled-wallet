...
import { Properties } from "@titan-wallet/analytics";
...
export const RoutePageAnalytics: FunctionComponent<{
  ...
  useEffect(() => {
    let p: Properties = {
      page_location: `https://titan.ext${prefix}${location.pathname}`,
      page_title: `${prefix}${location.pathname}`,
    };
    if (prevPathname.current) {
      p = {
        ...p,
        page_referrer: `https://titan.ext${prefix}${prevPathname.current}`,
      };
    }
