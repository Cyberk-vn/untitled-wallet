...
export const SettingGeneralLinkTitanMobilePage: FunctionComponent = observer(
  () => {
      ...
      <EnterPasswordView
        onSubmit={async (password) => {
          ...
          if (res.length === 0) {
            confirm.confirm(
              intl.formatMessage({
                id: "page.setting.general.link-titan-mobile.confirm-title",
              }),
              <React.Fragment>
                <FormattedMessage
                  id="page.setting.general.link-titan-mobile.confirm-paragraph"
                  values={{ br: <br /> }}
                />
              </React.Fragment>,
              {
  ...
  return (
    ...
    >
      <Styles.Container gutter="0.75rem">
        <GuideBox
          title={intl.formatMessage({
            id: "page.setting.general.link-titan-mobile.enter-password-view.guide-title",
          })}
          paragraph={intl.formatMessage({
            id: "page.setting.general.link-titan-mobile.enter-password-view.guide-paragraph",
          })}
        />
        ...
        <Styles.Paragraph>
          <FormattedMessage id="page.setting.general.link-titan-mobile.enter-password-view.paragraph" />
        </Styles.Paragraph>

        <TextInput
          label={intl.formatMessage({
            id: "page.setting.general.link-titan-mobile.enter-password-view.password-label",
          })}
          type="password"
          value={password}
          error={
    ...
    const id = setTimeout(() => {
      ...
      confirm
        .confirm(
          "",
          intl.formatMessage({
            id: "page.setting.general.link-titan-mobile.qr-code-view.session-expired",
          }),
          {
            forceYes: true,
            yesText: "Ok",
      ...
      try {
        (async () => {
          const { uri, approval } = await signClient.connect({
            requiredNamespaces: {
              cosmos: {
                methods: ["__titan_export_keyring_vaults"],
          ...
          if (uri) {
            ...
            await (async () => {
              ...
              await signClient.request({
                ...
                request: {
                  method: "__titan_export_keyring_vaults",
                  params: [
    ...
    >
      <Styles.Container>
        <Box padding="1.5rem">
          <YAxis alignX="center">
            <Styles.Paragraph>
              <FormattedMessage id="page.setting.general.link-titan-mobile.qr-code-view.paragraph" />
            </Styles.Paragraph>
                ...
                value={(() => {
                  if (isExpired) {
                    return intl.formatMessage({
                      id: "page.setting.general.link-titan-mobile.qr-code-view.expired",
                    });
                  }
